...
This program is used for inspecing the growth of Genome scale metabolic models (GSMMs) representing
a microbial community derived from a natural environment. It uses the Flux varibility analysis (FVA)
solutions of all models simulated in the natural rhizosphere environment, extracts their secretion
profiles, and iteratively adds the secretions to the environment for further simulations.

iterations begin with medium 0 - the original root enviornment.

@author: ginatta


Verifed same output with Alon on of iteration 1
Sun 15 Jan 2023 10:46:46 IST
"""
...
base_dir = '/home/gonc/freilichlab/shiri/communal_growth_project/original_code/IMCgm/'
...
def medium_dict_to_df(medium, target_path, medium_name: str):
    ...
    df_.to_csv(target_path + medium_name + '.csv')
...
def save_secretion_and_growths_dfs(growths, secretions_df, number: str):
    ...
    growth_df.to_csv(target_dir + 'growths_' + number + '.csv')
    secretions_df.to_csv(target_dir + 'secretion_' + number + '.csv')



# =============================================================================
# =============================================================================
# # iteration runs are separated since runtime is long and data acquisition
# # is necessary.
# =============================================================================
# =============================================================================
